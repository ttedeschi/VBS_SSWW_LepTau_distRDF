...
variables["SR"] = []
variables["SR"].append(variable('lepton_pt',  'Lepton p_{T} [GeV]', 6 , array("f", [30., 45., 60., 80., 100., 150, 250.]) ))
...
variables["fakes_CR"] = []
variables["fakes_CR"].append(variable('lepton_pt',  'Lepton p_{T} [GeV]', 6 , array("f", [30., 45., 60., 80., 100., 150, 250.]) ))
...
variables["ttbar_CR"] = []
variables["ttbar_CR"].append(variable('lepton_pt',  'Lepton p_{T} [GeV]', 8 , array("f", [30., 45., 60., 80., 100., 125., 150, 200., 250.]) ))
...
variables["OS_CR_bvetoL"].append(variable('lepton_pt',  'Lepton p_{T} [GeV]', 8 , array("f",  [30., 45., 60., 80., 100., 125., 150, 200., 250.]) ))
